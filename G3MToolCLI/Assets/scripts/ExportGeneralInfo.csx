...
try
{
    ...
    using (var writer = new Utf8JsonWriter(stream, new JsonWriterOptions { Indented = true }))
    {
        ...
        writer.WriteStartObject();
        writer.WriteBoolean("fullscreen", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.Fullscreen) != 0);
        writer.WriteBoolean("syncVertex1", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.SyncVertex1) != 0);
        writer.WriteBoolean("syncVertex2", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.SyncVertex2) != 0);
        writer.WriteBoolean("interpolate", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.Interpolate) != 0);
        writer.WriteBoolean("scale", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.Scale) != 0);
        writer.WriteBoolean("showCursor", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.ShowCursor) != 0);
        writer.WriteBoolean("sizeable", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.Sizeable) != 0);
        writer.WriteBoolean("screenKey", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.ScreenKey) != 0);
        writer.WriteBoolean("syncVertex3", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.SyncVertex3) != 0);
        writer.WriteBoolean("studioVersionB1", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.StudioVersionB1) != 0);
        writer.WriteBoolean("studioVersionB2", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.StudioVersionB2) != 0);
        writer.WriteBoolean("studioVersionB3", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.StudioVersionB3) != 0);
        writer.WriteBoolean("studioVersionMask", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.StudioVersionMask) != 0);
        writer.WriteBoolean("steamEnabled", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.SteamEnabled) != 0);
        writer.WriteBoolean("useAppDataSaveLocation", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.UseAppDataSaveLocation) != 0);
        writer.WriteBoolean("borderlessWindow", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.BorderlessWindow) != 0);
        writer.WriteBoolean("javaScriptMode", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.JavaScriptMode) != 0);
        writer.WriteBoolean("licenseExclusions", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.LicenseExclusions) != 0);
        writer.WriteBoolean("gameRunFromGMS2IDE", (Data.GeneralInfo.Info & GameMakerGeneralInfo.InfoFlags.GameRunFromGMS2IDE) != 0);
